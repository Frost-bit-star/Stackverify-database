    ...
    <div className="mx-auto max-w-3xl space-y-8">
      <div className="card">
        ...
        <p className="mt-2 text-gray-700">
          You’ve successfully registered/logged in. Your personal schema is live
          and ready.
        </p>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <Copy
            ...
            value={
              me?.schema ||
              (typeof window !== "undefined"
                ? localStorage.getItem("sv_schema")
                : "") ||
              ""
            }
          />
...
// Use your credentials (or set db.token = "${
...
console.log(tables);`}</pre>
        ...
        <div className="mt-4 rounded-xl bg-amber-50 p-4 text-amber-900">
          ...
          will be part of upcoming paid plans on <i>stackverify.site</i>. The SDK
          remains free — query anything on your own.
        </div>

        <div className="mt-6 flex gap-3">
          <a
            href="https://www.npmjs.com/package/@stackverify/db"
            target="_blank"
      ...
      <div className="card">
        ...
        {tables.length === 0 ? (
          <p className="mt-2 text-gray-600">
            No tables found yet. Create via SQL in your app using{" "}
            <code>db.query()</code>.
          </p>
        ) : (
